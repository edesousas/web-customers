<?php
    ...
    if ($operacio=="new") {
        ...
        $sql="UPDATE customers SET surname=\"$surname\",name=\"$name\",phonenumber=\"$phonenumber\",mail=\"$mail\",address=\"$address\" , parroquies=\"$parroquies\" WHERE id_customer=$id_customer;";
    }
    obrirConnexioBD();
        ...
        <html lang="en">
            ...
            <body>
                <div class="alert alert-danger" role="alert">
                    <h3>Error creant/modificant customer</h3>
                    <p><?=$conn->error?></p>
                </div>
            </body>
        </html>
