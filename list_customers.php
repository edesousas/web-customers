        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Esteu segur que voleu esborrar el customer?</p>
                </div>   
...
<?php
        obrirConnexioBD();
        $sql = "SELECT * FROM customers i INNER JOIN parroquies p ON i.parroquia=p.id_parroquia ORDER BY id_customer;";
...
<?php
        ...
        echo "No hi ha costumers";
    }
    tancarConnexioBD();
?>
<a type="button" href="form_customers.php?operacio=new" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> nou customer</a>
